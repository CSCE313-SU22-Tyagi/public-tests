...
timeout 1 strace -e trace=openat -f -o test-files/trace ./client -s Texas >/dev/null 2>&1
...
echo -e "\nTesting :: ./client -s Texas\n"
remake
timeout 2 ./server > test-files/out_server.txt 2>/dev/null &
timeout 2 ./client -s Texas > test-files/out_client.txt 2>/dev/null
wait
...
echo -e "\nTesting :: ./client -s Colorado\n"
remake
timeout 2 ./server > test-files/out_server.txt 2>/dev/null &
timeout 2 ./client -s Colorado > test-files/out_client.txt 2>/dev/null
wait
...
echo -e "\nTesting :: ./client -s Something\n"
remake
timeout 2 ./server >test-files/out_server.txt 2>/dev/null &
timeout 2 ./client -s Something > test-files/out_client.txt 2>/dev/null
wait
...
echo -e "\nTesting :: ./client -s Nevada\n"
remake
timeout 2 ./server >test-files/out_server.txt 2>/dev/null &
timeout 2 ./client -s Nevada > test-files/out_client.txt 2>/dev/null
wait
